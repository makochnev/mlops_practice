    ...
    def upload():
        if request.method == 'POST':
            ...
            if file and allowed_file(file.filename):
                ...
                new_filename = f'{filename.split(".")[0]}_{str(datetime.now())[:-7].replace(" ", "_").replace(":", "-")}.csv'
                # new_filename = f'{filename.split(".")[0]}_new.csv'
